...
namespace Disruptor.Tests.Dsl
{
	...
	public class DisruptorTests
	{
	  ...
	  public void ShouldCreateEventProcessorGroupForFirstEventProcessors()
	  {
		...
		{
			var wrappedException = new StructWrapper<Threading.Volatile.Reference<Exception>> {
				Value = new Threading.Volatile.Reference<Exception>()
			};
	...
	private Exception WaitFor(StructWrapper<Threading.Volatile.Reference<Exception>> reference)
	{
